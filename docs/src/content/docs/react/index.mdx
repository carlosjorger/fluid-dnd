...
head:
  - tag: title
    content: Fluid DnD 💧 Drag and Drop Library for React
description: "Official documentation for Fluid DnD, a fluid, agnostic and versatil drag and drop library for lists with current support for React 3 and Svelte."
template: splash
hero:
  tagline: "<strong>Fluid DnD</strong> is a fluid and agnostic drag and drop solution for lists, full animated. With current support for React 3 and Svelte."
  image:
    dark: ../../../assets/dark-logo.svg
    light: ../../../assets/logo.svg
  actions:
    - text: Read Docs
      link: /react/introduction/introduction/
      icon: right-arrow
      variant: primary
    - text: Examples
      link: /react/example/vertical-list/single-vertical-list/
      icon: right-arrow
      variant: secondary
    - text: Source Code
